...
extern int copy_file_custom(const std::string &from, const std::string &to, const bool with_check = false, bool shield_gas = true, float dwell_t = 3.5, float traverse_speed=850.0, std::string hopper = "91");
