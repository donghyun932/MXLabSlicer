...
static const char* URL_CHANGELOG = "http://files.mxlab3d.com/?latest=slicer-stable&lng=%1%";
static const char* URL_DOWNLOAD = "https://www.prusa3d.com/downloads&lng=%1%";
static const char* URL_DEV = "https://github.com/donghyun932/MXLabSlicer/releases/tag/version_%1%";

static const std::string CONFIG_UPDATE_WIKI_URL("https://github.com/donghyun932/MXLabSlicer/wiki/Slic3r-PE-1.40-configuration-update");
...
{
	logo->SetBitmap(create_scaled_bitmap(this, "MXLabSlicer_192px_grayscale.png", 192));
	...
	MsgDialog(nullptr, _(L("Configuration update")), _(L("Configuration update")))
{
	...
	static const wxString url("https://github.com/donghyun932/MXLabSlicer/wiki/Slic3r-PE-1.40-configuration-update");
